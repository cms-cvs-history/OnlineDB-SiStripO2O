...
output_file_name=root/MonitorPedNoise_${CondDb}_${tagIOV}.root 
...
templatefile=${CMSSW_BASE}/src/OnlineDB/SiStripO2O/test/template_SiStripMonitorPedNoise.cfg
[ ! -e $templatefile ] && templatefile=${CMSSW_RELEASE_BASE}/src/OnlineDB/SiStripO2O/test/template_SiStripMonitorPedNoise.cfg
...
cat $templatefile | sed -e "s#insert_runNb#${run}#" -e "s#insert_DBfile#$DBfile#" -e "s#insert_DBcatalog#$DBcatalog#" -e "s#insert_output_filename#${output_file_name}#"  -e "s#insert_tagPN#${tagPN}#g"  -e "s#insert_tagCab#${tagCab}#g" > ${cfg_file}
